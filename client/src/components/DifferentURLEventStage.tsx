      ...
      <div>
          <div className="main_stage_container">
              <div style={{
                ...
                <h1 style={{fontSize: '30px', color:'white'}}>Event will be held on a different webpage. Please click <a  className="hello" href={props.event.url} target="_blank">here</a> </h1>
              </div>
